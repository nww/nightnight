...
(function(){
  console.log()
    ...
    if(!getCookie('nightnightOff')){
      ...
      wrapper.innerHTML = '<div class="nightnight animated fadeIn"><div>It&rsquo;s late&hellip;</div><div> Nothing we can offer you is more important than your sleep.</div> <div> Sleep well, sweet dreams, and we will catch you in the morning.</div> <div class="nightnight-timing">This site will wake up at ' + 
        time + 
